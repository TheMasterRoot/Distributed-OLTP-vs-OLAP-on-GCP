    ...
    content: (
      <div className="flex flex-col items-center justify-center h-full text-center space-y-8">
        ...
        <div className="space-y-4">
          <h1 className="text-6xl md:text-7xl font-black tracking-tight text-[#202124] leading-tight">
            Distributed OLTP <br />vs OLAP on GCP
          </h1>
          <p className="text-2xl md:text-3xl text-[#5F6368] font-medium max-w-2xl mx-auto">
            Deep Dive: Mastering Architectural Decisions <br />
            <span className="text-[#EA4335] text-xl font-bold uppercase tracking-widest">(Expert Level)</span>
          </p>
        </div>

        <div className="pt-8 text-xs font-bold text-[#4285F4] uppercase tracking-[0.3em] bg-blue-50 px-4 py-2 rounded-full border border-blue-100">
    ...
    content: (
      <div className="grid h-full w-full max-w-none grid-cols-1 gap-5 md:grid-cols-[0.9fr_1.1fr]">
        <div className="flex min-h-0 flex-col justify-center rounded-3xl bg-[#202124] p-6 text-white shadow-2xl">
          <p className="mb-3 text-sm font-black uppercase tracking-[0.32em] text-[#FBBC04]">Start with the workload</p>
          ...
          <div className="mt-5 rounded-2xl border border-white/10 bg-white/5 p-4">
            <p className="text-sm font-bold uppercase tracking-widest text-[#D2E3FC]">Guiding question</p>
            <p className="mt-2 text-2xl font-black text-white">Am I changing the state of the business or analyzing its history?</p>
          </div>
        </div>
          ...
          {[
            ...
            return (
              <div key={item.title} className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
                <div className="absolute right-5 top-4 text-6xl font-black text-slate-100">{String(index + 1).padStart(2, '0')}</div>
                <div className="relative flex gap-3">
                  ...
                  <div>
                    <h3 className="mb-1 text-xl font-black text-[#202124]">{item.title}</h3>
                    <p className="text-base leading-6 text-[#5F6368]">{item.text}</p>
                  </div>
                </div>
              </div>
            );
      ...
      <div className="grid h-full w-full max-w-none grid-cols-1 gap-4 md:grid-cols-[1fr_0.9fr_1fr]">
        <div className="flex min-h-0 flex-col overflow-hidden rounded-3xl border border-[#D2E3FC] bg-white shadow-xl">
          <div className="bg-[#E8F0FE] p-3">
            <p className="text-sm font-black uppercase tracking-[0.28em] text-[#1967D2]">OLTP</p>
            <h3 className="mt-1 text-2xl font-black text-[#202124]">Run the business</h3>
            <p className="mt-1 text-sm leading-5 text-[#3C4043]">Fast, consistent transactions for operational systems.</p>
          </div>
          <div className="flex flex-1 flex-col gap-1.5 p-3">
            {[
              ...
              <div key={label} className="rounded-xl border border-blue-100 bg-blue-50/70 p-2">
                <p className="text-xs font-black uppercase tracking-widest text-[#1967D2]">{label}</p>
                <p className="mt-0.5 text-sm font-bold leading-4 text-slate-800">{text}</p>
              </div>
            ))}
            <div className="mt-auto rounded-xl bg-[#1967D2] p-2 text-white">
              <p className="text-sm font-black">Best fit: Cloud SQL, AlloyDB, Spanner</p>
            </div>
          </div>
        </div>

        <div className="flex min-h-0 flex-col justify-center rounded-3xl bg-[#202124] p-4 text-white shadow-2xl">
          <p className="mb-3 text-center text-sm font-black uppercase tracking-[0.25em] text-[#FBBC04]">Workload Signal</p>
            ...
            {[
              ...
              <div key={label} className="space-y-2">
                <div className="flex items-center justify-between text-base font-bold">
                  <span>{label}</span>
                  <span className="text-sm uppercase tracking-widest text-slate-400">OLTP / OLAP</span>
                </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-2 text-center">
            <div className="rounded-2xl bg-[#4285F4] px-3 py-2">
              <p className="text-base font-black">ms: OLTP thinks in latency</p>
            </div>
            <div className="rounded-2xl bg-[#34A853] px-3 py-2">
              <p className="text-base font-black">TB: OLAP thinks in volume</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex min-h-0 flex-col overflow-hidden rounded-3xl border border-green-100 bg-white shadow-xl">
          <div className="bg-green-50 p-3">
            <p className="text-sm font-black uppercase tracking-[0.28em] text-[#188038]">OLAP</p>
            <h3 className="mt-1 text-2xl font-black text-[#202124]">Understand the business</h3>
            <p className="mt-1 text-sm leading-5 text-[#3C4043]">Large-scale analysis for decisions, reporting, and discovery.</p>
          </div>
          <div className="flex flex-1 flex-col gap-1.5 p-3">
            {[
              ...
              <div key={label} className="rounded-xl border border-green-100 bg-green-50/70 p-2">
                <p className="text-xs font-black uppercase tracking-widest text-[#188038]">{label}</p>
                <p className="mt-0.5 text-sm font-bold leading-4 text-slate-800">{text}</p>
              </div>
            ))}
            <div className="mt-auto rounded-xl bg-[#188038] p-2 text-white">
              <p className="text-sm font-black">Best fit: BigQuery, Looker, BI Engine</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-none">
        <div className="space-y-6">
          <div className="bg-[#E8F0FE] p-6 rounded-xl border border-blue-100">
            <h3 className="text-xl font-bold text-[#1967D2] mb-3">When Single Node Fails</h3>
            <ul className="space-y-3 text-base text-[#3C4043]">
        ...
        <div className="bg-slate-900 p-8 rounded-2xl text-white flex flex-col justify-center">
          ...
          <h3 className="text-2xl font-bold mb-4 italic">"Growth is a tax on infrastructure."</h3>
  ...
  },
  {
    ...
    content: (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-none">
        <div className="space-y-6">
          <div className="bg-[#E8F0FE] p-6 rounded-xl border border-blue-100">
            <h3 className="text-xl font-bold text-[#1967D2] mb-3">Postgres Internals: MVCC</h3>
            <ul className="space-y-3 text-base text-[#3C4043]">
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
            <h4 className="text-xs font-black text-slate-400 uppercase mb-3">Detecting Bloat</h4>
...
ORDER BY n_dead_tup DESC;`}
        ...
        <div className="bg-slate-900 p-8 rounded-2xl text-white flex flex-col justify-center">
          ...
          <h3 className="text-2xl font-bold mb-4 italic">"The reported size isn't always real."</h3>
          <p className="text-slate-400 text-base leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-none">
        <div className="space-y-6">
          <div className="p-6 bg-white rounded-xl border border-slate-200 shadow-sm">
            <h4 className="text-base font-bold text-slate-800 mb-4">01. Partial Indexes</h4>
            <p className="text-sm text-slate-500 mb-2">Why index 100M rows if you only query 'ACTIVE' users? Save space and write IO.</p>
            <pre className="bg-slate-50 p-3 rounded font-mono text-xs text-blue-600">
...
WHERE status = 'ACTIVE';`}
          ...
          <div className="p-6 bg-white rounded-xl border border-slate-200 shadow-sm">
            <h4 className="text-base font-bold text-slate-800 mb-4">02. Ordered (DESC) Indexes</h4>
            <p className="text-sm text-slate-500 mb-2">Indexes are ordered. If you query \`ORDER BY created_at DESC\`, your index should match.</p>
            <pre className="bg-slate-50 p-3 rounded font-mono text-xs text-blue-600">
...
ON orders(created_at DESC);`}
        ...
        <div className="bg-[#EA4335] p-8 rounded-2xl text-white flex flex-col justify-center transition-all hover:scale-[1.02]">
          ...
          <h3 className="text-2xl font-bold mb-4 uppercase tracking-tighter italic">"Scanning is Losing"</h3>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-slate-900 text-white">
              <th className="p-3 text-xs font-bold uppercase">Dimension</th>
              <th className="p-3 text-xs font-bold uppercase">Cloud SQL HA</th>
              <th className="p-3 text-xs font-bold uppercase text-[#FBBC04]">AlloyDB</th>
              <th className="p-3 text-xs font-bold uppercase">Vitess / Citus</th>
              <th className="p-3 text-xs font-bold uppercase text-[#4285F4]">Cloud Spanner</th>
            </tr>
          </thead>
          <tbody className="text-xs divide-y divide-slate-100">
            ...
            <tr>
              ...
              <td className="p-3 text-xs">&lt;5K TPS, single region, full SQL surface</td>
              <td className="p-3 text-xs font-bold text-[#B06000]">HTAP on Postgres, regional only</td>
              <td className="p-3 text-xs">Already on Postgres, can't migrate keys</td>
              <td className="p-3 text-xs font-bold text-[#4285F4]">&gt;20K TPS or multi-region writes</td>
            </tr>
          </tbody>
        </table>
        <div className="p-3 bg-blue-50 text-blue-800 text-center text-xs border-t border-blue-100 font-bold italic">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-none">
        <div className="space-y-6">
          <div className="p-6 bg-red-50 rounded-xl border border-red-100">
            ...
            <div className="space-y-4">
               <div>
                  <h4 className="text-base font-bold text-slate-800">01. Manual Hashing</h4>
                  <p className="text-sm text-slate-600">Using \`MOD(hash(key), N)\` to distribute keys. Prevents hotspots but makes Range Scans (BETWEEN) impossible without hitting all shards.</p>
               </div>
               <div>
                  <h4 className="text-base font-bold text-slate-800">02. Application Complexity</h4>
                  <p className="text-sm text-slate-600">The app must maintain a "Shard Map". Distributed transactions (2PC) become a performance nightmare.</p>
               </div>
            </div>
          </div>
          <div className="bg-white p-6 rounded-xl border border-slate-200">
            <h4 className="text-sm font-black text-slate-400 uppercase mb-2">The Resharding Tax</h4>
            <p className="text-sm text-slate-500 italic">"Scaling from 2 to 4 shards usually involves manual data migration, downtime, or building complex live-copy scripts. It is the silent killer of engineering velocity."</p>
          </div>
        </div>
        <div className="flex flex-col gap-4">
          <div className="bg-slate-900 p-6 rounded-xl text-white">
             <h4 className="text-yellow-400 font-mono text-sm mb-4">// Manual Router Pseudo-code</h4>
...
// 15/16 of your keys will move to a different shard.`}
          ...
          <div className="p-4 bg-white border-2 border-dashed border-red-200 rounded-xl">
             <h4 className="text-xs font-black text-red-500 uppercase mb-2">Cons of Manual Path</h4>
      ...
      <div className="grid h-full w-full max-w-none grid-cols-1 gap-5 md:grid-cols-[0.78fr_1.22fr]">
        <div className="flex min-h-0 flex-col gap-4">
          <div className="rounded-2xl border border-red-100 bg-red-50 p-5">
            <h3 className="mb-2 flex items-center gap-3 text-xl font-black text-[#EA4335]">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
              <h4 className="mb-2 text-base font-black text-slate-800">Why not <code>hash(key) % N</code>?</h4>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
              <h4 className="mb-2 text-base font-black text-slate-800">Virtual Nodes Smooth the Load</h4>
              <p className="text-sm leading-6 text-slate-600">
          ...
          <div className="rounded-2xl bg-slate-900 p-4 text-white">
            <h4 className="mb-3 flex items-center gap-2 text-sm font-black uppercase tracking-[0.2em] text-[#FBBC04]">
        ...
        <div className="flex min-h-0 flex-col rounded-3xl border border-[#D2E3FC] bg-[#E8F0FE] p-4 shadow-2xl">
          <div className="mb-3 flex items-center justify-between gap-4">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.25em] text-[#4285F4]">Consistent Hashing</p>
              <h3 className="text-2xl font-black text-[#202124]">Ring Routing, Failure, and Virtual Nodes</h3>
            </div>
            <div className="hidden rounded-full bg-white px-3 py-1 text-xs font-black uppercase tracking-widest text-[#1967D2] shadow-sm sm:block">
          ...
          <div className="mt-3 grid grid-cols-3 gap-3">
            <div className="rounded-xl bg-white p-2 text-center">
              <p className="text-xs font-black text-[#1967D2]">1. Hash request</p>
            </div>
            <div className="rounded-xl bg-white p-2 text-center">
              <p className="text-xs font-black text-[#EA4335]">2. Walk clockwise</p>
            </div>
            <div className="rounded-xl bg-white p-2 text-center">
              <p className="text-xs font-black text-[#188038]">3. Use next healthy node</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6 w-full max-w-none">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="bg-[#4285F4] text-white p-4 rounded-xl shadow-md">
            <p className="text-xs uppercase tracking-widest opacity-80">Throughput / node</p>
            <p className="text-3xl font-black mt-1">~10K QPS</p>
            <p className="text-xs opacity-90 mt-1">~5–7K in practice, linear scale</p>
          </div>
          <div className="bg-[#4285F4] text-white p-4 rounded-xl shadow-md">
            <p className="text-xs uppercase tracking-widest opacity-80">Storage cost</p>
            <p className="text-3xl font-black mt-1">$0.30/GB</p>
            <p className="text-xs opacity-90 mt-1">regional · $0.50 multi-region</p>
          </div>
          <div className="bg-[#1967D2] text-white p-4 rounded-xl shadow-md">
            <p className="text-xs uppercase tracking-widest opacity-80">Cost floor</p>
            <p className="text-3xl font-black mt-1">~$650/mo</p>
            <p className="text-xs opacity-90 mt-1">1 regional node minimum</p>
          </div>
          <div className="bg-[#EA4335] text-white p-4 rounded-xl shadow-md">
            <p className="text-xs uppercase tracking-widest opacity-80">Multi-region write p50</p>
            <p className="text-3xl font-black mt-1">~100 ms</p>
            <p className="text-xs opacity-90 mt-1">physics floor: Paxos quorum</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="bg-white p-5 rounded-xl border-t-4 border-[#EA4335] shadow-md">
            <h4 className="font-bold text-base mb-2">Anti-Pattern: Monotonic PKs</h4>
            <p className="text-sm text-slate-500">Incremental IDs concentrate writes on the last split — one node hot, the rest idle.</p>
            <div className="mt-3 p-2 bg-red-50 text-red-600 text-xs font-mono border border-red-100 rounded">
              BAD: 1, 2, 3...<br />
          ...
          <div className="bg-white p-5 rounded-xl border-t-4 border-[#4285F4] shadow-md">
            <h4 className="font-bold text-base mb-2">Interleaving</h4>
            <p className="text-sm text-slate-500">Co-locate child rows under parent. Joins become local. Rule: parent + children &lt; 8 GB.</p>
            <pre className="mt-3 text-xs bg-slate-50 p-2 rounded">
{`INTERLEAVE IN PARENT Customers
ON DELETE CASCADE`}
            </pre>
          </div>
          <div className="bg-white p-5 rounded-xl border-t-4 border-[#34A853] shadow-md">
            <h4 className="font-bold text-base mb-2">Stored Columns</h4>
            <p className="text-sm text-slate-500">Add covering columns to indexes to avoid base-table lookups on hot read paths.</p>
            <div className="mt-3 p-2 bg-green-50 text-green-700 text-xs font-mono border border-green-100 rounded">
              CREATE INDEX ...<br />
              STORING (col1, col2)
            </div>
          </div>
        ...
        <div className="bg-[#202124] p-6 rounded-2xl text-white flex gap-6 items-center">
          <div className="w-14 h-14 shrink-0 bg-[#4285F4] rounded-full flex items-center justify-center font-black text-2xl">PK</div>
          <div className="space-y-1">
            <h3 className="text-xl font-bold">Spanner removes the sharding tax, not the modeling tax</h3>
        ...
        <div className="space-y-6">
          <div className="p-6 bg-green-50 rounded-xl border border-green-100">
            ...
            <div className="bg-white p-4 rounded-lg border border-green-200">
              <span className="text-xs uppercase font-black text-slate-400">Standard DDL</span>
...
CLUSTER BY user_id, status;`}
          ...
          <div className="p-4 bg-[#F8F9FA] rounded-xl border border-slate-200">
             <h4 className="text-sm font-black mb-2 uppercase">Slot Management</h4>
             <p className="text-sm text-slate-500">Slots are units of computation. Use <strong>Reservations</strong> for predictable runtime, or <strong>On-Demand</strong> for burst. Deeply monitor `avg_slot_ms` to find inefficient queries.</p>
          </div>
        </div>
        
        <div className="flex flex-col gap-6">
          <div className="bg-white p-6 rounded-2xl shadow-md border-t-4 border-[#34A853]">
            <h4 className="text-base font-bold mb-4">Anti-Pattern: The "Select *" Tax</h4>
            <p className="text-base text-slate-600 mb-4">BQ is Columnar. Scanning unused columns is literal waste of money and throughput.</p>
    ...
    content: (
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-none">
        <div className="bg-white p-8 rounded-2xl shadow-lg border-b-8 border-[#4285F4]">
          ...
          <h3 className="font-bold text-xl mb-4 text-slate-800">Spanner: Paxos + TrueTime</h3>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border-b-8 border-[#34A853]">
          ...
          <h3 className="font-bold text-xl mb-4 text-slate-800">BigQuery: Dremel Tree</h3>
          <p className="text-base text-slate-600 leading-relaxed">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border-b-8 border-[#EA4335]">
          ...
          <h3 className="font-bold text-xl mb-4 text-slate-800">Cloud SQL: Multi-Version (MVCC)</h3>
          <p className="text-base text-slate-600 leading-relaxed">
        ...
        <div className="bg-white p-10 rounded-3xl shadow-xl w-full border-t-8 border-[#FBBC04]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-4 bg-slate-50 rounded-xl">
              <span className="text-sm font-black text-slate-400 uppercase">Input</span>
              <h4 className="font-bold my-2">CDC (Debezium/Datastream)</h4>
              <p className="text-sm text-slate-500">Reads DB logs (WAL) instead of querying tables. Zero impact on OLTP CPU.</p>
            </div>
            <div className="p-4 bg-slate-50 rounded-xl">
              <span className="text-sm font-black text-slate-400 uppercase">Process</span>
              <h4 className="font-bold my-2">Dataflow (Beam)</h4>
              <p className="text-sm text-slate-500">Stateful processing for deduplication and sessions. Handles late data.</p>
            </div>
            <div className="p-4 bg-slate-50 rounded-xl">
              <span className="text-sm font-black text-slate-400 uppercase">Output</span>
              <h4 className="font-bold my-2">BigQuery Write API</h4>
              <p className="text-sm text-slate-500">Storage-optimized ingest. High throughput, lower cost than traditional inserts.</p>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-5 w-full max-w-none">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white p-5 rounded-2xl border-t-4 border-[#EA4335] shadow-md flex flex-col gap-3">
            <div>
              <p className="text-xs font-black uppercase tracking-widest text-[#EA4335]">Case 01 · Cloud SQL</p>
              <h4 className="font-black text-base text-slate-800 mt-1">Silent bloat from a long transaction</h4>
            </div>
            <div className="text-sm leading-5 text-slate-600 space-y-2">
            ...
            <div className="mt-auto bg-red-50 border border-red-100 rounded-lg p-2 text-xs">
          ...
          <div className="bg-white p-5 rounded-2xl border-t-4 border-[#4285F4] shadow-md flex flex-col gap-3">
            <div>
              <p className="text-xs font-black uppercase tracking-widest text-[#4285F4]">Case 02 · Spanner</p>
              <h4 className="font-black text-base text-slate-800 mt-1">8 nodes paid, 1 node hot</h4>
            </div>
            <div className="text-sm leading-5 text-slate-600 space-y-2">
            ...
            <div className="mt-auto bg-blue-50 border border-blue-100 rounded-lg p-2 text-xs">
          ...
          <div className="bg-white p-5 rounded-2xl border-t-4 border-[#34A853] shadow-md flex flex-col gap-3">
            <div>
              <p className="text-xs font-black uppercase tracking-widest text-[#34A853]">Case 03 · BigQuery</p>
              <h4 className="font-black text-base text-slate-800 mt-1">24x cheaper, same output</h4>
            </div>
            <div className="text-sm leading-5 text-slate-600 space-y-2">
            ...
            <div className="mt-auto bg-green-50 border border-green-100 rounded-lg p-2 text-xs">
        ...
        <div className="bg-[#202124] p-5 rounded-2xl text-white flex flex-col md:flex-row gap-4 items-start md:items-center">
          <div className="shrink-0">
            <p className="text-[#FBBC04] text-xs font-black uppercase tracking-widest">Senior Tweak Checklist</p>
            <p className="text-lg font-bold mt-1">Always look at the plan. Never trust the SQL.</p>
          </div>
          <ul className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-1 text-sm text-slate-300">
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col gap-5 w-full max-w-none">
        <div>
          <p className="text-xs font-black uppercase tracking-[0.3em] text-[#4285F4] mb-2">Six Commandments</p>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {[
              ...
              <div key={c.n} className="bg-white rounded-xl border border-slate-200 shadow-sm p-3 flex gap-3 items-start">
                <div className="w-10 h-10 shrink-0 rounded-lg flex items-center justify-center text-white text-sm font-black" style={{ backgroundColor: c.color }}>{c.n}</div>
                <div className="min-w-0">
                  <h4 className="text-sm font-black text-slate-800 leading-tight">{c.title}</h4>
                  <p className="text-sm text-slate-500 leading-snug mt-1">{c.text}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-[#202124] rounded-2xl p-5 shadow-xl">
          <div className="flex items-center justify-between mb-4">
            <p className="text-xs font-black uppercase tracking-[0.3em] text-[#FBBC04]">Decision Tree</p>
            <p className="text-xs text-slate-400 italic">From workload signal to GCP service</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <p className="text-xs font-black uppercase tracking-widest text-[#4285F4]">Step 1 · Spanner</p>
              <p className="text-white text-sm font-bold mt-2 leading-tight">Multi-region writes <span className="text-slate-400 font-normal">or</span> &gt; 20K TPS?</p>
              <p className="text-slate-400 text-sm mt-2">Choose <strong className="text-white">Cloud Spanner</strong> — global consistency, linear scale.</p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <p className="text-xs font-black uppercase tracking-widest text-[#FBBC04]">Step 2 · AlloyDB</p>
              <p className="text-white text-sm font-bold mt-2 leading-tight">PostgreSQL features + HTAP, regional only?</p>
              <p className="text-slate-400 text-sm mt-2">Choose <strong className="text-white">AlloyDB</strong> — ~4x Cloud SQL writes, columnar engine.</p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <p className="text-xs font-black uppercase tracking-widest text-[#34A853]">Step 3 · Cloud SQL</p>
              <p className="text-white text-sm font-bold mt-2 leading-tight">&lt; 5K TPS, single region, mainstream SQL?</p>
              <p className="text-slate-400 text-sm mt-2">Choose <strong className="text-white">Cloud SQL HA</strong> — simplest, ~US$ 350/mo floor.</p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <p className="text-xs font-black uppercase tracking-widest text-[#EA4335]">Step 4 · BigQuery</p>
              <p className="text-white text-sm font-bold mt-2 leading-tight">Analytical, &gt; 1 TB scans?</p>
              <p className="text-slate-400 text-sm mt-2">Choose <strong className="text-white">BigQuery</strong> — Editions once &gt; 50 TB/mo.</p>
            </div>
          </div>
          <p className="text-center text-sm text-slate-300 italic mt-4">
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col items-center justify-center h-full text-center space-y-12">
        ...
        <div className="space-y-4">
          <h2 className="text-6xl font-black text-slate-900 uppercase tracking-tighter italic">Questions?</h2>
          <p className="text-2xl text-slate-500 font-medium tracking-wide">Let's discuss Slot management, Spanner split points, or Federation strategies.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-none">
          ...
          >
            <p className="text-xs font-black uppercase tracking-[0.25em] text-[#4285F4]">Repository</p>
            <p className="mt-2 text-base font-bold text-slate-800">Download the source and presentation material</p>
          </a>
          <a
            href="/script"
          ...
          >
            <p className="text-xs font-black uppercase tracking-[0.25em] text-[#1967D2]">Speaker Notes</p>
            <p className="mt-2 text-base font-bold text-slate-800">Open the full speech at /script</p>
          </a>
          <a
            href="/qa"
          ...
          >
            ...
            <p className="mt-2 text-base font-bold text-slate-800">Open prepared Q&A at /qa</p>
          </a>
        </div>

        <div className="pt-8 flex flex-col items-center gap-4">
          <div className="flex gap-8 text-sm font-black text-slate-400 uppercase tracking-[0.3em] border-t border-slate-100 pt-8">
      ...
      <header className="sticky top-0 z-20 border-b border-[#D2E3FC] bg-white/95 backdrop-blur px-6 py-4">
        <div className="mx-auto flex max-w-5xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-black uppercase tracking-[0.25em] text-[#4285F4]">{copy.presentationScript}</p>
              <h1 className="text-2xl font-black tracking-tight">{translateText('Cloud Data Architecture at Scale', language)}</h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="/"
              className="rounded-full border border-[#D2E3FC] bg-[#E8F0FE] px-4 py-2 text-sm font-black uppercase tracking-widest text-[#1967D2] transition hover:bg-[#D2E3FC]"
            >
              {copy.backToSlides}
            </a>
          </div>
      ...
      <header className="sticky top-0 z-20 border-b border-[#FCE8E6] bg-white/95 backdrop-blur px-6 py-4">
        <div className="mx-auto flex max-w-5xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-black uppercase tracking-[0.25em] text-[#EA4335]">{copy.qaBank}</p>
              <h1 className="text-2xl font-black tracking-tight">{translateText('Cloud Data Architecture at Scale', language)}</h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="/"
              className="rounded-full border border-[#FCE8E6] bg-[#FEF7F6] px-4 py-2 text-sm font-black uppercase tracking-widest text-[#EA4335] transition hover:bg-[#FCE8E6]"
            >
              {copy.backToSlides}
            </a>
          </div>
    ...
    <div className="fixed inset-0 bg-[#F8F9FA] overflow-hidden flex items-center justify-center px-5 py-2.5">
      ...
      <div className="w-full h-full bg-white text-[#3C4043] font-sans overflow-hidden flex flex-col border-[6px] md:border-[8px] border-[#4285F4] shadow-2xl relative">
        ...
        <header className="h-16 md:h-[72px] bg-white border-b border-gray-100 flex items-center justify-between px-6 md:px-10 z-20">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-[#202124]">{translateText('Data Architecture Masterclass', language)}</h1>
              <p className="text-xs md:text-sm text-[#5F6368] font-bold uppercase tracking-widest leading-none">
          ...
          <div className="flex items-center gap-3 text-right">
            ...
            <a
              href="/script"
              className="hidden text-xs md:text-sm font-bold text-[#4285F4] bg-[#E8F0FE] px-3 py-1 rounded-full border border-[#D2E3FC] transition hover:bg-[#D2E3FC] sm:inline-block"
            >
            ...
            >
              <div className="w-full h-full max-w-none mx-auto flex flex-col">
                ...
                <div className="mb-2 hidden md:block">
                  <div className="flex items-center gap-2 text-[#4285F4] font-bold text-lg uppercase tracking-tighter">
        ...
        <footer className="h-9 md:h-10 bg-[#E8F0FE] flex items-center px-6 md:px-10 justify-between z-30 border-t border-[#D2E3FC]">
          <div className="flex gap-4 md:gap-6 text-xs md:text-sm font-bold text-[#1967D2] uppercase tracking-wider">
          ...
          <div className="flex items-center gap-3">
            <div className="text-xs md:text-sm text-gray-500 font-medium uppercase tracking-tight hidden sm:block">
